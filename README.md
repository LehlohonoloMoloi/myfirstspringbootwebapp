## This is a basic web app that allows the user to manage their todos. Spring security is used to provide security, and the app makes use of a MySQL db to store todo details.
